    ...
    <div>
        <div className="flex flex-col items-center justify-center py-10 mt-10">
            <div className="text-center space-y-4 lg:mx-0 mx-5">
              ...
              <p className="text-slate-500 ">Partner with us to make your establishment EV ready and further boost your profits.</p>
            </div>

            <div className="mt-5 grid lg:grid-cols-5 gap-3 md:grid-cols-3 grid-cols-2 ">
