          ...
          >
            <div className="flex flex-1 xl:gap-x-6">
              ...
              <div className="relative flex-1 after:w-[1px] after:h-full after:bg-black/10  after:absolute after:top-0 after:right-0">
                ...
                <div className=" text-sm xl:text-md leading-[1.4] max-w-[100px] dark:text-blue-300">
                  CO2 Reduced
                </div>
              </div>
              {/* Fuel replaced */}
              <div className="relative flex-1 after:w-[1px] after:h-full after:bg-black/10 after:absolute after:top-0 after:right-0">
                ...
                <div className="text-sm xl:text-md  leading-[1.4] max-w-[200px] dark:text-blue-300">
