  ...
  return (
    <div>
        <div className="flex flex-col lg:flex-row bg-blue-900 dark:bg-blue-950  pt-9 items-center">
            ...
            <div className="lg:w-[726px]" data-aos="fade-up" data-aos-duration="1000">
             <img src={co2} alt="reducing co2" className="w-full" />
            </div>

            <div className="bg-white dark:bg-slate-800  md:p-10 p-4 lg:w-[656px] md:text-[20px] lg:h-[499px] flex flex-col justify-center"  data-aos="fade-down" data-aos-duration="1000">
