  ...
  return (
    <div className='mt-8'>
      <div className="flex flex-col justify-center items-center mx-4 gap-5">
       <p className="lg:text-[59px] md:text-[42px] text-[32px] font-bold  bg-clip-text text-transparent bg-slate-900 dark:bg-gradient-to-r from-yellow-300 to-slate-400   ">The Future of EV Charging</p>
