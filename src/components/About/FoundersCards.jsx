...
const FoundersCards = ({ img, name, role, linkedIn, email }) => {
  return (
    <div data-aos="fade-up" data-aos-duration="1500" className="bg-white dark:bg-indigo-50 rounded-lg p-4 m-2 shadow-lg w-[270px] ">
      <div className="h-[219px] mb-4 rounded">
      ...
      <div className="flex mt-4 space-x-3">
        ...
        <a href={`mailto:${email}`} className="text-yellow-500">
           ...
           <img src={mailicon} alt="" className="w-6 h-6 hover:scale-125  duration-500" fill="currentColor" viewBox="0 0 24 24"/>
