  ...
  return (
    <div >
      ...
      <div className="flex flex-col gap-16 mt-10">
        ...
        {/* first */}
        <div data-aos="fade-up" data-aos-duration="1500" className={`  flex flex-col lg:flex-row bg-gradient-to-r from-yellow-400 to-amber-100 dark:bg-gradient-to-r dark:from-indigo-900 dark:to-indigo-400 pt-9 items-center w-fit mx-auto`}>
        ...
        <div data-aos="fade-up" data-aos-duration="1500" className={`flex flex-col lg:flex-row-reverse bg-gradient-to-l from-yellow-400 to-amber-100 dark:bg-gradient-to-l dark:from-indigo-900 dark:to-indigo-400 pt-9 items-center w-fit mx-auto `}>

          <div className="lg:w-[726px]">
            <img data-aos-duration="1000" src={aboutImg} alt="" className="w-full" />
          </div>
