...
<div className="bg-white dark:bg-slate-800  md:p-10 p-4 lg:w-[656px] md:text-[20px] lg:h-[499px] flex flex-col justify-center gap-2 ">
    ...
    <p className="dark:text-slate-300 ">To become a leader in developing a sustainable and renewable technologies such as future alternate fuels and to actively participate and strive for the common goal of achieving complete carbon neutrality for the betterment of society. To excel in our commitment and known universally for the quality, services and innovations in our areas of operations.</p>
</div>
        </div>
