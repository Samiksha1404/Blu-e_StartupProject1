...
const ServiceSolutioncard = ({image,title}) => {
  return (
    <div data-aos="zoom-in" data-aos-duration="2000" className='lg:w-[202px] flex flex-col justify-center items-center gap-3 '> 
        ...
        <div className="">
            <h1 data-aos="fade-up" data-aos-duration="1000"  className="text-center lg:text-[25px] font-bold text-indigo-900 dark:text-indigo-400/80 md:text-[20px] text-[17px]">{title}</h1>
        </div>
    </div>
  )
}
