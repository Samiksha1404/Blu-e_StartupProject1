     ...
     <ChargeSteps/>
      ...
      <div className="">
        <div data-aos="fade-down" data-aos-duration="1000" class="mt-8 md:mx-auto mx-4 flex flex-col gap-5 lg:w-[1195px] md:text-xl  text-justify dark:text-slate-400 ">
          ...
          <p  data-aos="fade-up" data-aos-duration="1000" class="">We pride ourselves on our commitment to sustainability and environmental responsibility. Our charging stations utilize clean energy sources, further reducing carbon emissions and promoting a greener future. With our reliable network of charging stations, electric vehicle owners can confidently embark on their journeys, knowing that they have a dependable charging partner along the way.
          ...
          <p  data-aos="fade-down" data-aos-duration="1000" class="">Choose Us ,as your charging station service provider and join the electric revolution. Experience the convenience, reliability, and environmental benefits of our cutting-edge charging solutions, as we work together towards a sustainable future.</p>
