...
const Applications = () => {
  return (
    <>
         ...
         <div data-aos="fade-up" data-aos-duration="2000" className="flex flex-col lg:space-y-20 items-center ">
          <p className="md:text-[48px] text-[32px] font-bold text-blue-950  text-center dark:text-slate-100">Applications</p>
        </div>
        <div data-aos="fade-down" data-aos-duration="1000" className="flex flex-col lg:space-y-20 items-center ">
        <p className="md:text-[28px] text-[22px] font-bold dark:text-blue-300 text-center text-yellow-400" >Simple Installations</p>
        </div>
      
     <div className="flex justify-left  md:justify-center   flex-wrap ">
