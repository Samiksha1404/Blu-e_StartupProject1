...
<div className='p-4'>
        <div  className=" flex flex-col lg:flex-row   dark:bg-white  items-center w-fit mx-auto ">
         ...
         <div data-aos="fade-up" data-aos-duration="1000" className="bg-white dark:bg-slate-800  md:p-10 p-4 lg:w-[756px] md:text-[20px] lg:h-[570px] flex flex-col justify-center gap-2 ">
            {/* heading */}
